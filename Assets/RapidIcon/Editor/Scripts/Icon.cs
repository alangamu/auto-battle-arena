...
namespace RapidIconUIC
{
	...
	public class Icon
	{
		...
		{
			fullRender = Utils.RenderIcon(this, fullRenderSize.x, fullRenderSize.y, FilterMode.Point);
		}

		public void Update(Vector2Int fullRenderSize, Vector2Int previewSize)
		{
			previewRender = Utils.RenderIcon(this, previewSize.x, previewSize.y, FilterMode.Point);
			fullRender = Utils.RenderIcon(this, fullRenderSize.x, fullRenderSize.y, FilterMode.Point);
		}
